...
TEST_F(GraphOptz, concatReshapes) {
  ...
  for (size_t i = 0; i < 10; i++) {
    ...
    // The optimization would kick in, as the granularity of original
  ...
  for (size_t i = 0; i < 10; i++) {
    ...
    // And a ConcatNode concatenates the outputs of reshape at 2nd dim.
    // The optimization would NOT kick in, as the granularity of original
  ...
  // After optimization, we expect to see only 15 nodes.
