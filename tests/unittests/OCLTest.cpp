...
//     device_ = devices[0];
//     context_ = clCreateContext(nullptr, 1, &device_, nullptr, nullptr,
//     nullptr); ASSERT_TRUE(context_) << "clCreateContext failed";
...
// /// Tests that the command queue pool returns an error when a queue is
// requested
...
//   // The retuned queues should have been the same and only one should have
//   been
//   // allocated.
...
//   // The retuned queues should not have been the same and two should have
//   been
