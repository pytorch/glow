...
__kernel void oclavgpool_i8W(__global void *mem, cl_uint32_t dest, cl_uint32_t src,
                       cl_uint32_t filterSize, cl_uint32_t stride, PaddingTLBR pads, 
                       ShapeNCHW odim, ShapeNCHW idim, cl_int32_t srcOffset, 
                       QuantizationTransform32To8 destScaleParams) {
  oclavgpool_i8K(&mem[dest], &mem[src], filterSize, stride, pads, 
                odim, idim, srcOffset, destScaleParams.offset, 
                destScaleParams.pre, destScaleParams.post,
