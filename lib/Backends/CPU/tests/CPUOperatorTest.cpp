...
std::set<std::string> glow::backendTestBlacklist = {
    ...
    "MaxPool3D/0",
    "Int8MaxPool3D/0",
    "FloatMaxPool3DWithArgmax/0",
    "QuantizedMaxPool3DWithArgmax/0",
    "FloatMaxPool3DWithArgmaxTransposed/0",
    "QuantizedMaxPool3DWithArgmaxTransposed/0",
    "NonSquareKernelMaxPool3D/0",
    "NonSquareStrideMaxPool3D/0",
    "MaxPool3DLargePads_FloatTy/0",
    "MaxPool3DLargePads_Int8QTy/0",
};
