...
#define DEFINE_DATA_PARALLEL_KERNEL_QUANTIZED(name, type, body)                \
  ...
  int32_t lhs = libjit_scale_i32i8(LHS[idx] - lhsOffset, lhsPre, lhsPost, lhsScale, 0);    \
  int32_t rhs = libjit_scale_i32i8(RHS[idx] - rhsOffset, rhsPre, rhsPost, rhsScale, 0);    \
...
DEFINE_DATA_PARALLEL_KERNEL(libjit_element_mul_kernel_f, float,
                            LHS[idx] * RHS[idx])
DEFINE_DATA_PARALLEL_KERNEL_QUANTIZED(libjit_element_add_kernel_i8, int8_t, lhs + rhs)
