...
const std::map<std::string, INNPINodeImporter *> NNPIImporter::nodeImporters_ =
    {
        {"", nullptr},
        {"Convolution", new ConvolutionNodeImporter()},
        {"Transpose", new TransposeNodeImporter()},
        {"MaxPool", new PoolNodeImporter<glow::MaxPoolNode, NNPI_POOL_MAX>()},
        {"AvgPool", new PoolNodeImporter<glow::AvgPoolNode, NNPI_POOL_AVG>()},
        {"FullyConnected", new FullyConnectedNodeImporter()},
        ...
        {"Max",
         new BinaryEltwiseNodeImporter<glow::MaxNode, NNPI_ELTWISE_MAX>()},
        {"Min",
         new BinaryEltwiseNodeImporter<glow::MinNode, NNPI_ELTWISE_MIN>()},
        {"Add",
         new BinaryEltwiseNodeImporter<glow::AddNode, NNPI_ELTWISE_ADD>()},
        {"Mul",
         new BinaryEltwiseNodeImporter<glow::MulNode, NNPI_ELTWISE_MUL>()},
        {"Div",
         new BinaryEltwiseNodeImporter<glow::DivNode, NNPI_ELTWISE_DIV>()},
        {"Sub",
         new BinaryEltwiseNodeImporter<glow::SubNode, NNPI_ELTWISE_SUB>()},
        {"Pow",
         new BinaryEltwiseNodeImporter<glow::PowNode, NNPI_ELTWISE_POW>()},
        {"CmpEQ",
         new BinaryEltwiseNodeImporter<glow::CmpEQNode, NNPI_ELTWISE_EQ>()},
        {"CmpLTE",
         new BinaryEltwiseNodeImporter<glow::CmpLTENode, NNPI_ELTWISE_LTE>()},
        {"CmpLT",
         new BinaryEltwiseNodeImporter<glow::CmpLTNode, NNPI_ELTWISE_LESS>()},
        {"ArgMax", new ArgMaxNodeImporter()},
        {"Reshape", new ReshapeNodeImporter()},
        {"Quantize", new ConvertNodeImporter<QuantizeNode>()},
        ...
        {"Concat", new ConcatNodeImporter()},
        {"Tile", new TileNodeImporter()},
        {"Gather", new GatherNodeImporter()},
        ...
        {"ReplaceNaN", new ReplaceNaNNodeImporter()},
        {"GatherRanges", new GatherRangesNodeImporter()},
        {"BatchedAdd", new BatchAddNodeImporter()},
        {"RowwiseQuantizedSparseLengthsWeightedSum", new RQSLWSNodeImporter()},
        {"FusedRowwiseQuantizedSparseLengthsWeightedSum",
         new FRQSLWSNodeImporter()},
        {"LengthsRangeFill", new LengthsRangeFillNodeImporter()},
        {"BatchOneHot", new BatchOneHotNodeImporter()},
        {"NNPICustomDSP", new NNPICustomDSPNodeImporter()},
        {"SpaceToDepth", new SpaceToDepthNodeImporter()},
        {"Clip", new ClipNodeImporter()},
};
