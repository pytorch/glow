...
struct BlacklistInitializer {
  BlacklistInitializer() {
    ...
    { {"add_int32/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"SparseToDense_Float_Int32/0", TestBlacklist::AnyDeviceAnyEngine},
      {"SparseToDense_Float16_Int32/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"Neg_Int32ITy/0", TestBlacklist::AnyDeviceAnyEngine},
