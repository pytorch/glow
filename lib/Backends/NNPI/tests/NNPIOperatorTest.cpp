  ...
  BlacklistInitializer() {
    ...
    { {"add_int32/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"rowwiseQuantizedFCTestAsymmetric_Int8_BiasFloat32/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataInt64IdxInt64/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataInt64IdxInt32/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataInt32IdxInt64/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataInt32IdxInt32/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataFloatIdxInt64/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataFloatIdxInt32/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataFloat16IdxInt64/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataFloat16IdxInt32/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataBFloat16IdxInt64/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataBFloat16IdxInt32/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataQInt8IdxInt32/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"GatherElementsDataFloatIdxNegInt32/0",
       TestBlacklist::AnyDeviceAnyEngine},
