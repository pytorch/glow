    ...
    const std::vector<std::pair<std::string, uint32_t>> testBlacklistedSetups =
        {
            ...
            {"FloatMaxPoolWithArgmaxTransposed/0",
             TestBlacklist::AnyDeviceAnyEngine},
            {"FP16AdaptiveAvgPool/0", TestBlacklist::AnyDeviceAnyEngine},
            ...
            {"FusedRowwiseQuantizedSparseLengthsWeightedSum_ConvertedFloat16_"
             "NoFusedConvert/0",
             TestBlacklist::AnyDeviceAnyEngine},
            {"GroupConv3D/0", TestBlacklist::AnyDeviceAnyEngine},
            ...
            {"Int8AdaptiveAvgPool/0", TestBlacklist::AnyDeviceAnyEngine},
            ...
            {"NonCubicStrideConv3D/0", TestBlacklist::AnyDeviceAnyEngine},
            ...
            {"sliceVectors_Int32/0", TestBlacklist::AnyDeviceAnyEngine},
            ...
            {"EmbeddingBagByteRowwiseOffsets_Float16_AccumFloat16_End_Offset/0",
             TestBlacklist::AnyDeviceAnyEngine},
            {"SparseToDense/0", TestBlacklist::AnyDeviceAnyEngine},
            ...
            {"testQuantizedBatchAdd/0", TestBlacklist::AnyDeviceAnyEngine},
            ...
            {"CmpEQ/0", TestBlacklist::AnyDeviceHWEngine},
