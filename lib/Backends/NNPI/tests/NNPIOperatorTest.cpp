...
struct BlacklistInitializer {
  BlacklistInitializer() {
    ...
    { {"add_int64/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"SparseLabelSplit/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"GatherND_Float16Ty_Int32ITy_Test1/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int32ITy_Test2/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int32ITy_Test3/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int32ITy_Test4/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int32ITy_Test5/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int64ITy_Test1/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int64ITy_Test2/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int64ITy_Test3/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int64ITy_Test4/0", TestBlacklist::AnyDeviceAnyEngine},
      {"GatherND_Float16Ty_Int64ITy_Test5/0", TestBlacklist::AnyDeviceAnyEngine},
