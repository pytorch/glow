...
struct BlacklistInitializer {
  BlacklistInitializer() {
    ...
    { {"add_int32/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"CumSum_2D_Int32/0", TestBlacklist::AnyDeviceAnyEngine},
      {"CumSum_3D_Int64/0", TestBlacklist::AnyDeviceAnyEngine},
      {"CumSum_4D_Float/0", TestBlacklist::AnyDeviceAnyEngine},
      {"CumSum_4D_Reverse/0", TestBlacklist::AnyDeviceAnyEngine},
      {"CumSum_4D_Exclusive/0", TestBlacklist::AnyDeviceAnyEngine},
      {"CumSum_4D_ReverseExclusive/0", TestBlacklist::AnyDeviceAnyEngine},
