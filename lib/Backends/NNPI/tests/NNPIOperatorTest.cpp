...
struct BlacklistInitializer {
  BlacklistInitializer() {
    ...
    { {"add_int32/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"Upsample_Nearest2D_Int8/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"ArithAdd_int32_t/0", TestBlacklist::AnyDeviceAnyEngine},
      {"ArithAdd_int64_t/0", TestBlacklist::AnyDeviceAnyEngine},
      {"ArithMax_int32_t/0", TestBlacklist::AnyDeviceAnyEngine},
      {"ArithMax_int64_t/0", TestBlacklist::AnyDeviceAnyEngine},
      {"ArithMin_int32_t/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"ArithDiv_int32_t/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"batchedReduceProd_Float/0", TestBlacklist::AnyDeviceHWEngine},
      {"batchedReduceProd_Float16/0", TestBlacklist::AnyDeviceHWEngine},
      {"batchedReduceProd_BFloat16/0", TestBlacklist::AnyDeviceHWEngine},
      {"batchedReduceProd_Int32/0", TestBlacklist::AnyDeviceHWEngine},
      {"batchedReduceProd_Int64/0", TestBlacklist::AnyDeviceHWEngine},
      {"batchedReduceProd_Int8/0", TestBlacklist::AnyDeviceHWEngine},
      ...
      {"BFloat16MaxPool3D/0", TestBlacklist::AnyDeviceAnyEngine},
      {"FP16MaxPool3D/0", TestBlacklist::AnyDeviceAnyEngine},
      {"MaxPool3D/0", TestBlacklist::AnyDeviceAnyEngine},
      {"Int8MaxPool3D/0", TestBlacklist::AnyDeviceAnyEngine},
      {"FloatMaxPool3DWithArgmax/0", TestBlacklist::AnyDeviceAnyEngine},
      {"QuantizedMaxPool3DWithArgmax/0", TestBlacklist::AnyDeviceAnyEngine},
      {"FloatMaxPool3DWithArgmaxTransposed/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"QuantizedMaxPool3DWithArgmaxTransposed/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"NonSquareKernelMaxPool3D/0", TestBlacklist::AnyDeviceAnyEngine},
      {"NonSquareStrideMaxPool3D/0", TestBlacklist::AnyDeviceAnyEngine},
      {"MaxPool3DLargePads_FloatTy/0", TestBlacklist::AnyDeviceAnyEngine},
      {"MaxPool3DLargePads_Int8QTy/0", TestBlacklist::AnyDeviceAnyEngine},
    };
