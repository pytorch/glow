  ...
  BlacklistInitializer() {
    ...
    { {"add_int32/0", TestBlacklist::AnyDeviceAnyEngine},
      ...
      {"batchedReduceAddWithAxis_BFloat16/0",
       TestBlacklist::AnyDeviceAnyEngine},
      {"batchedReduceAnd/0", TestBlacklist::AnyDeviceAnyEngine},
      {"batchedReduceAnd_outerAxis/0", TestBlacklist::AnyDeviceAnyEngine},
      {"batchedReduceAnd_innerAxis/0", TestBlacklist::AnyDeviceAnyEngine},
      {"batchedReduceAnd_lastAxis/0", TestBlacklist::AnyDeviceAnyEngine},
      {"batchedReduceAnd_4Dinput/0", TestBlacklist::AnyDeviceAnyEngine},
      {"batchedReduceAnd_5Dinput/0", TestBlacklist::AnyDeviceAnyEngine},
