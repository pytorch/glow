...
class PyTorchPretrainedModel(object):
    ...
    def export_onnx_model(self, input_name, output_name, batch_size, model_path,
                          verbose):
...
if __name__ == "__main__":
    ...
    pytorch_model.export_onnx_model(args.model_input_name,
                                    args.model_output_name, args.batch_size,
                                    args.model_path, args.verbose)
