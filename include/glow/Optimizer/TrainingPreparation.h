...
/// \p inputIdx, and fills out (optionally) \p tensor.
...
/// Function takes glow::Function \p F, \p bindings and \p initializer for the
/// input weights.
llvm::Error prepareFunctionForTraining(
    Function *F, PlaceholderBindings &bindings,
